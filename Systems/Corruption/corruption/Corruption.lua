...
local timeToSet = 10          -- time will runs the applyCorruptionDebuff function to check if player has item on them and that they got correct buffs. (in seconds)
local corruptionSpell = 82215 -- Spell to show the corruption stacks need a spell that can stack as i apply the stacks to the spell

-- [itemId] = stack to give
local items = {
  [12185] = 40,
  [22745] = 20,
  [22742] = 20,
