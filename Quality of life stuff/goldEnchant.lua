                        ...
                        if v[3] then
                            ...
                            if pVar[player:GetName()] == 151 then
                                if (WType == 1 or WType == 5 or WType == 6 or WType == 8 or WType == 10) then
                                    ...
                                    player:SendAreaTriggerMessage(
                                        "|Cffff0000[Enchanter]|r: " ..
                                            item:GetItemLink(0) .. " is succesfully enchanted!"
                                    )
                                else
                                    player:SendAreaTriggerMessage(
                                        "|Cffff0000[Enchanter]|r: You do not have a Two-Handed Weapon equipped!"
                                    )
                                end
                            elseif pVar[player:GetName()] == 161 then
                                if (Wtype == 6) then
                                    ...
                                    player:SendAreaTriggerMessage(
                                        "|Cffff0000[Enchanter]|r: You do not have a Shield equipped!"
                                    )
                                end
                            end
                        else
